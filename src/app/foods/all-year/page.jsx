...
const foods = [
  ...
  export default function Food() {
    ...
    const allFood = foods.filter(food => food.season === 'Year-round')
    
    const foodfiltered = allFood.filter(food => food.name.toLowerCase().includes(searchFood.toLowerCase()) || food.season.toLowerCase().includes(searchFood.toLowerCase()))
