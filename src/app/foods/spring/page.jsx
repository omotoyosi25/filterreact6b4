...
const foods = [
  ...
  export default function Food() {
    ...
    const springFood = foods.filter(food => food.season === 'Spring')
    
    const foodfiltered = springFood.filter(food => food.name.toLowerCase().includes(searchFood.toLowerCase()) || food.season.toLowerCase().includes(searchFood.toLowerCase()))
