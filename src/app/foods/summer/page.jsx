...
const foods = [
  ...
  export default function Food() {
    ...
    const summerFood = foods.filter(food => food.season === 'Summer')
    
    const foodfiltered = summerFood.filter(food => food.name.toLowerCase().includes(searchFood.toLowerCase()) || food.season.toLowerCase().includes(searchFood.toLowerCase()))
